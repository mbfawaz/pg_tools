...
vector<double> matrix::backward_forward_substitution(sparse_matrix &A, vector<double> &b)
{
...
{
    // chol_factorize matrix A
    if(A.is_chol_factorized() == false)
        chol_factorize(A);
    //return vector
                                             ...
                                             sparse_matrix & C)
{
    ...
    else
    {
        ...
        chol_Ai = (UF_long*)chol_A->i;
        chol_Ap = (UF_long*)chol_A->p;
        ...
        chol_Bi = (UF_long*)chol_B->i;
        chol_Bp = (UF_long*)chol_B->p;
        ...
        chol_Ci = (UF_long*)chol_C->i;
        chol_Cp = (UF_long*)chol_C->p;
...
sparse_matrix::sparse_matrix(sparse_matrix & sparse_matrix_to_copy)
{
    ...
    _chol_factorized = sparse_matrix_to_copy.is_chol_factorized();
    _global_sparse_matrix_iterator++;
    _local_sparse_matrix_iterator = _global_sparse_matrix_iterator;
}
...
//! This method checks if the sparse matrix is already chol-factorized or not 
//! \return bool
bool sparse_matrix::is_chol_factorized()
{
    return _chol_factorized;
}
...
double sparse_matrix::get_element(int row, int col)
{
    ...
    {
        cout<<row<<"\t"<<col<<endl;
        cout<<_number_of_rows<<"\t"<<_number_of_columns<<endl;
...
//! This method sets the flag that indicates if the matrix is already chol-factorized or not
//! @param chol_factorize [in]: new value of the flag
void sparse_matrix::set_chol_factorized(bool chol_factorize)
{
    _chol_factorized = chol_factorize;
}
